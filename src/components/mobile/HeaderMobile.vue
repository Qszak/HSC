    ...
    <div class="Content">
      ...
      <div class="sidebar" :class="{ 'active': isMenuOpen }">
        <ul>
          ...
          <li @click="toggleMenu">Oferta</li>
          <li @click="toggleMenu">Kadra</li>
          <li @click="toggleMenu">O nas</li>
          <li @click="toggleMenu">Fizjoterapia</li>
          <li @click="toggleMenu">Dietetyka</li>
          <li @click="toggleMenu">Sklep</li>
...
.Content {
    display: flex;
    padding: var(--space-100, 0.5rem) 0rem;
    justify-content: flex-end;
    align-items: center;
    gap: 2rem;
    flex: 1 0 0;
...
.Menu {
 ...
 .menu-icon {
  ...
  /* Active class for sliding in the menu */
  .sidebar.active {
    display: block;
  }
