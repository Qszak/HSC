export const coachData = [
    {
        ...
        imgSrc: "/images/kadra/MichałKulej.png",
    ...
    },
    {
        ...
        imgSrc: "/images/kadra/KlaudiaŻmijewska.png",
    ...
    },
    {
        ...
        position: "Trener Personalny",
        skills: "personal, medical, combat, motor",
        imgSrc: "/images/kadra/MateuszFlejterski.png",
    ...
    },
    {
        ...
        imgSrc: "/images/kadra/TomaszRudolf.png",
    ...
    },
    {
        ...
        position: "Trener Personalny",
        skills: "personal",
        imgSrc: "/images/kadra/SandraCieślik.png",
    ...
    },
    {
        ...
        skills: "combat",
        imgSrc: "/images/kadra/AdrianSpętany.png",
    ...
    },
    {
        ...
        skills: "combat",
        imgSrc: "/images/kadra/KamilŁata.png",
    ...
    },
    {
        ...
        position: "Trener Personalny",
        skills: "personal, combat",
        imgSrc: "/images/kadra/DominikWarmiłło.png",
    ...
    },
    {
        ...
        position: "Trener MMA",
        skills: "combat",
        imgSrc: "/images/kadra/PatrykMikulski.png",
    ...
    },
    {
        ...
        position: "Trener Personalny",
        skills: "personal",
        imgSrc: "/images/kadra/TomaszMitrosz.png",
        imgAlt: "Zdjęcie Tomasza Mitrosza",
        description:
            "Instruktor sportu ze specjalizacją podnoszenie ciężarów, technik masażysta, praktyk z wieloletnim doświadczeniem zawodniczym i instruktorskim, prowadzący i autor szkoleń z zakresu techniki podnoszenia ciężarów. Podnoszenie ciężarów trenować zaczął w 2001 roku w klubie Burza Wrocław, następnie w UKS Talent Wrocław.\nDzięki połączeniu doświadczenia wyniesionego z podnoszenia ciężarów, fizjoterapii oraz masażu dostosowuje szkolenie techniczne jak i programowanie treningu siłowego do osób na każdym poziomie. Na co dzień prowadzący treningi z podopiecznymi we Wrocławiu, a także współpracuje z czołowymi zawodnikami crossfitu w Polsce.",
    },
    {
        id: "GS1",
        ...
        position: "Trener Personalny",
        skills: "personal, combat",
        imgSrc: "/images/kadra/GrzegorzSkołuda.png",
        imgAlt: "Zdjęcie Grzegorza Skołudy",
        description:
            "Trener personalny z wieloletnim doświadczeniem, 5 lat zwieńczone poziomem magistra na Akademii Wychowania Fizycznego oraz liczne odbyte kursy i szkolenia dotyczące treningu oraz żywienia i suplementacji pozwalające na kompleksowe przekazywanie wiedzy i zadbanie o podopiecznego.\nPrywatnie trener oraz zawodnik Brazylijskiego Jiu Jitsu, wielokrotny zdobywca medali Mistrzostw Polski oraz ogólnopolskich turniejów. Główny Trener zdobywającego sukcesy na arenie ogólnopolskiej oraz europejskiej, klubu Berserkers Team Wrocław.",
    },
    {
        id: "PG1",
    ...
    },
    {
        ...
        position: "Trener Personalny",
        skills: "personal",
        imgSrc: "/images/kadra/MarcinWoźniak.png",
        imgAlt: "Zdjęcie Marcina Woźniaka",
        description:
            "Ze sportem jestem związany od najmłodszych lat, pasję do sportu zaszczepił we mnie mój Tato, który był reprezentantem Polski w sekcji podnoszenia ciężarów.\nW wieku 8 lat rozpocząłem przygodę z piłką nożną w WKS Śląsk Wrocław, reprezentowałem większość dyscyplin sportu w szkołach do których uczęszczałem, a ciekawostką może być fakt, iż kilka moich rekordów nadal wisi na salach gimnastycznych.\nJestem absolwentem “Global Sports Academy” gdzie ukończyłem kurs trenera personalnego w 2020 roku, cały czas czas stawiam na rozwój sportowy jak i zawodowy.\nStaram się być na bieżąco z najnowszymi trendami treningowymi, poprzez uczestnictwo w różnych kursach kierunkowych, a także czytając książki związane z tematyką treningową.\nPasjonat wielu dyscyplin sportowych o których chętnie mogę porozmawiać.\nPoza piłką nożną, trenowałem CrossFit, Muai Thai, podnoszenie ciężarów, czy aktualnie Kickboxing.\nMoją specjalizacją są treningi siłowe, skupiam się na modelowaniu sylwetki, poprzez redukowanie tkanki tłuszczowej i budowanie masy mięśniowej.",
    },
    {
        id: "TW1",
        name: "Tomasz Wroński",
        position: "Trener Personalny",
        skills: "personal, motor",
        imgSrc: "/images/kadra/TomaszWroński.png",
        imgAlt: "Zdjęcie Tomasza Wrońskiego",
        description:
            " Jestem młodym, ambitnym trener z wielkimi ambicjami i determinacją do wyznaczonych przez siebie celów. Aktualnie studiuję w Akademii Wychowania Fizycznego we Wrocławiu na kierunku „Sport”, lecz spędziłem już wiele lat na piłkarskich boiskach.\nMoją specjalizacją są treningi motoryczne. Sport to moje życie od najmłodszych lat. Jako trener, łączę moje doświadczenie sportowe z nieustannie pogłębiaaną wiedzą, której podstawą są studia na kierunku “Trener”.\nJestem aktywnym sportowcem, gram w piłkę nożną w czwartoligowej Polonii Środa Śląska. Wszechstronna sprawność fizyczna stanowi fundament zarówno dla mnie, jak i moich podopiecznych.\nOprócz treningów personalnych i motorycznych świetnie odnajduję się w pracy z dziećmi i młodzieżą.",
    },
    {
        id: "MB1",
        name: "Marcin Bachórz",
        position: "Trener Kickboxingu",
        skills: "combat",
        imgSrc: "/images/kadra/MarcinBachórz.png",
        imgAlt: "Zdjęcie Marcina Bachórz",
        description:
            "Praktycznie większość swojego życia poświęciłem uczeniu się oraz doskonaleniu sztuk i sportów walki. Przez te ponad 30 lat uczyłem się kung-fu wings tsung, karate i oczywiście Taekwondo! Poznałem też  i zafascynowałem się stylami tzw. Wewnętrznymi kung fu czyli Qigong, Tai-chi medytacja Zen.\nNa studiach AWF-u we Wrocławiu zacząłem mocno interesować się sportami siłowymi co zaowocowało po paru latach studiów zaczęciem uczenia się i rozwijania treningu przygotowania motorycznego. Dzięki temu wzbogaciłem swój warsztat pracy o kolejne cenne doświadczenie związane z odpowiedzią ocena motoryczna i doborem odpowiedniego treningu dla swoich klientów. Najważniejsze tytuły i dorobek sportowy:\n- Mistrz Świata w Taekwondo\n- 2 krotny Mistrz Europy Taekwondo\n- 5 krotny Mistrz Polski Taekwondo\n- Vice Mistrz Świata w Kickboxingu\n- 4 krotny Mistrz Polski w Kickboxingu\n- Na ringach zawodowych i Amatorskich stoczył ponad 50 walk w całej Europie!\nPracuję z ludźmi w każdym wieku i każdym poziomie zaawansowania. Mogę nauczyć Cię Walczyć, Wzmocnić Twoje Ciało , Wyciszyć i Wyostrzyć Zmysły i Uspokoić Twój Umysł… Oss",
    },
    {
        id: "VF1",
    ...
    },
    {
        ...
        skills: "office",
        imgSrc: "/images/kadra/ŁukaszSzefner.png",
        imgAlt: "Zdjęcie Łukasza Szefnera",
        description:
            "Studia licencjackie oraz magisterskie ukończył na Wrocławskiej Akademii Wychowania Fizycznego oraz w Wyższej Szkole Fizjoterapii. Specjalizuje się w diagnozowaniu zaburzeń i dysfunkcji w obrębie narządu ruchu. Ukończył specjalistyczne kursy i szkolenia z zakresu medycyny manualnej, terapii tkanek miękkich, masażu tkanek głębokich, igłoterapii suchej, pinoterapii, treningu funkcjonalnego.\nZdobytą wiedzę teoretyczną i praktyczną oraz doświadczenie zawodowe wykorzystuje, aby sprawnie i kompleksowo pomagać pacjentom powrócić do pełnej sprawności.",
    },
    {
        id: "NZ1",
        ...
        skills: "office",
        imgSrc: "/images/kadra/NataliaZieniewicz.png",
